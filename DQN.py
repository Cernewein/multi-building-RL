...
class DAgent():
    ...
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions,
        ...
        self.optimizer = optim.Adam(self.policy_net.parameters(), lr=lr, weight_decay=decay_rate)#optim.RMSprop(self.policy_net.parameters(), lr=lr, momentum=momentum, weight_decay=decay_rate) # #
